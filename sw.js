const CACHE_NAME = 'valprimos-20260530002019';
...
self.addEventListener('fetch', e => {
  ...
  if (url.includes('onesignal') || url.includes('docs.google.com') || url.includes('fonts.googleapis.com') || url.includes('fonts.gstatic.com')) { e.respondWith(fetch(e.request).catch(() => caches.match(e.request))); return; }
